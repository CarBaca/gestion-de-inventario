...
#### Original Source: Inventory Dataset available on [Kaggle](https://www.kaggle.com/datasets/bhanupratapbiswas/inventory-analysis-case-study)
...
## 'Automatización Watchdog' Folder
...
## 'CSV Finales' Folder
##### Here, the six final (.csv) files corresponding to each dataframe were stored after the ETL process.

## 'Diagrama Entidad-Relación' Folder
...
## 'Imagenes' Folder
##### This folder contains various images used during the project assembly and for general files.
